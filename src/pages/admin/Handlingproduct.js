          ...
          <div className="">
            <div className="row d-flex justify-content-center">
              ...
              <div className="col-lg-8 col-md-12 col-sm-12">
                ...
                >
                  <span>
                    <p className={styles.point} onClick={this.Favorite}>
                      Favorite & Promo
                    </p>
                  </span>
                  <span>
                  ...
                  <span>
                    <p className={styles.point} onClick={this.NonCoffee}>
                      Non Coffee
                    </p>
                  </span>
                  <span>
                ...
                >
                  <Link to="/handlingproduct/addproduct" className="mt-2">
                    Add New Product
                  </Link>
                </div>
              </div>
