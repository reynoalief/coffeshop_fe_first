...
const Profile = () => {
  ...
  const urlpatch = `${process.env.REACT_APP_BACKEND_HOST}/profile`;
  ...
  const handleSavePassword = () => {
    ...
    axios
      .patch(
        `${process.env.REACT_APP_BACKEND_HOST}/user/edit`,
        {
          ...
          >
            ...
            <div className={`${styles["data-form"]} d-flex flex-row p-3 `}>
              ...
              >
                ...
                <text className="text-muted">{profile.phone_number}</text>
              </div>
            </div>
            <div
              className={`${styles["title-form"]} d-flex flex-row justify-content-between my-3 px-5 py-2 `}
        ...
        <Modal.Body>
          <div style={{ display: "flex", flexDirection: "column" }}>
            ...
            >
              ...
              <span onClick={handleConfirmToggle} className={styles.oldPass}>
